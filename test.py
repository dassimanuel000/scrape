...
def poster(offresIndeed, driver):
    ...
    for item_job in offresIndeed:
        ...
        try:
            driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/div[3]/div[1]/div[2]/div[1]/div/div[1]/div[1]/div[2]/div[2]/div[3]/div[3]/div/div[2]/div[2]/p").send_keys(item_job['description'])
            print(item_job['description'])
            time.sleep(1)
        except NoSuchElementException:
            pass
