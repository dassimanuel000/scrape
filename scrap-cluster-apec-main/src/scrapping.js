    ...
    async scrapeCurrentPage(page) { //Gives us a table of pages in which we scrape
       ...
       table = hrefs;
        ...
        while(counter<=5){
            console.log(counter);
            let contract = 101888;
            //https://www.apec.fr/candidat/recherche-emploi.html/emploi?typesContrat=101888&fonctions=101784
            ...
            // https://www.apec.fr/candidat/recherche-emploi.html/emploi?typesContrat=${contract}&page=${counter} cdi
                url = `https://www.apec.fr/candidat/recherche-emploi.html/emploi?motsCles=Secr%C3%A9taire&fonctions=101832&typesContrat=${contract}&sortsType=DATE&page=${counter}`;
